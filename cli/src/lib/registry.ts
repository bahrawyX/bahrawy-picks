...
export const registry: RegistryEntry[] = [
  {
    ...
    title: 'Phone Input',
    description:
      'International phone number input with flag, country code dropdown, and E.164 output.',
  ...
  },
  {
    ...
    title: 'Stepper',
    description:
      'Horizontal and vertical step indicator with completed, current, error states.',
    files: ['stepper.tsx'],
  ...
  },
  {
    ...
    title: 'Number Input',
    description:
      'Numeric input with increment/decrement, long-press, prefix/suffix, and Intl formatting.',
  ...
  },
  {
    ...
    description:
      'Zod-validated multi-step form with animated step transitions and data persistence.',
  ...
  },
  {
    ...
    description:
      'Two-month calendar with presets, range highlight, and mobile drawer fallback.',
  ...
  },
  {
    ...
    title: 'File Upload',
    description:
      'Drag and drop file upload with previews, progress bars, and type/size validation.',
  ...
  },
  {
    ...
    description:
      'Wraps any element and makes it magnetically attract toward the cursor on hover.',
  ...
  },
  {
    ...
    title: 'Bento Grid',
    description:
      'Responsive bento-style grid with animated cards spanning multiple columns and rows.',
  ...
  },
  {
    ...
    title: 'Marquee Row',
    description:
      'Infinite scrolling marquee with seamless looping. Pure CSS, pause on hover.',
  ...
  },
  {
    ...
    title: 'Floating Dock',
    description:
      'macOS-style dock that magnifies icons near the cursor with spring physics.',
  ...
  },
  {
    ...
    description:
      'Animate elements into view on scroll with directional slides and stagger groups.',
  ...
  },
  {
    ...
    title: 'Data Table',
    description:
      'Production-grade data table with sorting, filtering, pagination, row selection, virtualization, and column resizing.',
    files: [
      'data-table/index.tsx',
      'data-table/toolbar.tsx',
      'data-table/pagination.tsx',
      'data-table/filter-badge.tsx',
      'data-table/column-header.tsx',
      'data-table/row-actions.tsx',
      'data-table/bulk-action-bar.tsx',
      'data-table/skeleton.tsx',
      'data-table/empty-state.tsx',
      'data-table/virtual-rows.tsx',
    ],
    dependencies: ['@tanstack/react-table', '@tanstack/react-virtual', 'framer-motion'],
    shadcnComponents: ['table', 'button', 'input', 'checkbox', 'dropdown-menu', 'select', 'badge', 'popover', 'command'],
  },
]
...
export const sharedFiles = [
  ...
  { src: 'lib/column-helpers.tsx', dest: 'lib/column-helpers.tsx' },
]
