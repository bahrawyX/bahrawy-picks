...
export const registry: RegistryEntry[] = [
  ...
  },
  {
    ...
    slug: 'aurora-sky',
    name: 'Aurora Sky',
    description: 'Night sky with twinkling stars; three multi-color aurora ribbons paint across the viewport via animated stroke-dashoffset as you scroll. A verse panel crossfades in the lower half.',
    category: 'gsap-section',
    dependencies: ['gsap', '@gsap/react', 'lucide-react'],
  },
  {
    ...
    slug: 'comet-trail',
    name: 'Comet Trail',
    description: 'A comet flies across a starfield along an SVG path. A glowing trail draws in behind it; waypoint stars light up sequentially and surface content cards.',
    category: 'gsap-section',
    dependencies: ['gsap', '@gsap/react', 'lucide-react'],
  },
]
