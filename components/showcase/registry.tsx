...
export const registry: RegistryEntry[] = [
  ...
  },
  {
    ...
    name: 'Type Tunnel',
    description:
      'Pinned scroll section that turns a list of headlines into a Z-axis tunnel. Each line lives at a different depth in 3D space; scrolling moves the camera forward through them so they arrive from the vanishing point, swell, then pass behind you. Spring-smoothed scroll progress so it feels even both directions.',
    category: 'gsap-section',
