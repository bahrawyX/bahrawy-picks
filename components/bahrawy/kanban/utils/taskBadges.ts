...
> = {
  ...
  medium: {
    label: 'Medium',
    className:
      'border-amber-500/25 bg-amber-500/10 text-amber-600 dark:text-amber-400 hover:bg-amber-500/15',
    itemClassName:
      'text-amber-600 dark:text-amber-400 focus:text-amber-700 dark:focus:text-amber-300 focus:bg-amber-500/15',
  },
  low: {
    label: 'Low',
...
export const DIFFICULTY_META: Record<
  TaskDifficulty,
  { label: string; short: string; className: string; itemClassName: string }
> = {
  easy: {
    label: 'Easy',
    short: 'E',
    ...
    itemClassName:
      'text-emerald-600 dark:text-emerald-400 focus:text-emerald-700 dark:focus:text-emerald-300 focus:bg-emerald-500/15',
  },
  medium: {
    label: 'Medium',
    short: 'M',
