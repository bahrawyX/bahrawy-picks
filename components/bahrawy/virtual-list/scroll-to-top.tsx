    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          onClick={onClick}
          className={cn(
            'absolute bottom-3 right-3 z-20 flex h-8 w-8 items-center justify-center rounded-full bg-white/10 text-white/60 hover:bg-white/20 hover:text-white transition-colors',
            className
          )}
