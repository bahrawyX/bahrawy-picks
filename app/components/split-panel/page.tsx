...
export const metadata: Metadata = metadataForSlug('split-panel')
const breadcrumb = breadcrumbJsonLdForSlug('split-panel')
const component = componentJsonLdForSlug('split-panel')
