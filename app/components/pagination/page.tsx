...
export const metadata: Metadata = metadataForSlug('pagination')
const breadcrumb = breadcrumbJsonLdForSlug('pagination')
const component = componentJsonLdForSlug('pagination')
