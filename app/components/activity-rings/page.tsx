...
export const metadata: Metadata = metadataForSlug('activity-rings')
const breadcrumb = breadcrumbJsonLdForSlug('activity-rings')
const component = componentJsonLdForSlug('activity-rings')
