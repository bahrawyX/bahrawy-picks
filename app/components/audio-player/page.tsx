...
export const metadata: Metadata = metadataForSlug('audio-player')
const breadcrumb = breadcrumbJsonLdForSlug('audio-player')
const component = componentJsonLdForSlug('audio-player')
