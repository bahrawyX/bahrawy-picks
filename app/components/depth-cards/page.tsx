...
const ITEMS: DepthCardItem[] = [
  ...
  },
  {
    ...
    eyebrow: 'middle',
    title: 'A step behind.',
    body: 'Sits one layer back. Picks up a bit of camera parallax.',
    accent: '#A78BFA',
    x: 62,
    y: 38,
    width: 32,
  },
  {
    ...
    eyebrow: 'middle',
    title: 'Another layer.',
    body: 'Same depth band as the first; parallaxes the same.',
    accent: '#22D3EE',
    x: 70,
    y: 70,
    width: 28,
  },
  {
    ...
    body: 'Scales down, drifts more with the cursor — sells the depth.',
    accent: '#FBBF24',
    x: 18,
    y: 28,
    width: 26,
  },
  {
    ...
    body: 'The deepest layer — almost background.',
    accent: '#34D399',
    x: 50,
    y: 18,
    width: 24,
