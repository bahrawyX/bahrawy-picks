...
export const metadata: Metadata = metadataForSlug('code-window')
const breadcrumb = breadcrumbJsonLdForSlug('code-window')
const component = componentJsonLdForSlug('code-window')
