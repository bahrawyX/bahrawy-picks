...
>
  ...
  return (
    <DocsPage
      title="Hover Card"
      slug="hover-card"
      description="A preview popup that appears with a configurable delay on hover. Portal-mounted and spring-positioned, flips when out of room, dismisses on mouse leave or Escape."
      category="93 · overlay"
    >
