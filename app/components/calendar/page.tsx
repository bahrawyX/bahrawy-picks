...
export const metadata: Metadata = metadataForSlug('calendar')
const breadcrumb = breadcrumbJsonLdForSlug('calendar')
const component = componentJsonLdForSlug('calendar')
