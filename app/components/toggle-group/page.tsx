...
export const metadata: Metadata = metadataForSlug('toggle-group')
const breadcrumb = breadcrumbJsonLdForSlug('toggle-group')
const component = componentJsonLdForSlug('toggle-group')
