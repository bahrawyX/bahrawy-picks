...
export const metadata: Metadata = metadataForSlug('floating-toolbar')
const breadcrumb = breadcrumbJsonLdForSlug('floating-toolbar')
const component = componentJsonLdForSlug('floating-toolbar')
