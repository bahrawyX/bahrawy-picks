...
export const metadata: Metadata = metadataForSlug('bottom-sheet')
const breadcrumb = breadcrumbJsonLdForSlug('bottom-sheet')
const component = componentJsonLdForSlug('bottom-sheet')
