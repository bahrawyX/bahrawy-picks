...
export const metadata: Metadata = metadataForSlug('bar-chart')
const breadcrumb = breadcrumbJsonLdForSlug('bar-chart')
const component = componentJsonLdForSlug('bar-chart')
