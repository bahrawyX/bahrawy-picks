...
export const metadata: Metadata = metadataForSlug('donut-chart')
const breadcrumb = breadcrumbJsonLdForSlug('donut-chart')
const component = componentJsonLdForSlug('donut-chart')
